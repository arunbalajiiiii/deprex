...
def get_intelligence() -> IntelligenceProvider:
    ...
    if settings.GEMINI_API_KEY:
        _singleton_instance = GeminiAdapter(api_key=settings.GEMINI_API_KEY)
    else:
        logger.warning("GEMINI_API_KEY not set. Using InMemoryIntelligenceAdapter for local dev/testing.")
